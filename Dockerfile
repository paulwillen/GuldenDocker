...
RUN wget https://github.com/Gulden/gulden-official/releases/download/v2.0.0.9/Gulden-2.0.0.9-x86_64-linux.tar.gz -P /guldenserver/ \
    && tar -xvf /guldenserver/Gulden-2.0.0.9-x86_64-linux.tar.gz -C /guldenserver \
    && rm /guldenserver/Gulden-2.0.0.9-x86_64-linux.tar.gz \
